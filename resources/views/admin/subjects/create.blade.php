...
@section('content')
<div class="mb-6"><h1 class="text-3xl font-bold text-gray-900">Add Subject</h1></div>
<div class="bg-white rounded-xl border border-gray-200 p-6 max-w-lg">
    ...
    <form method="POST" action="{{ route('admin.subjects.store') }}" class="space-y-4">
        ...
        <div class="flex gap-3 pt-2">
            <button type="submit" class="bg-gray-900 text-white px-5 py-2 rounded-lg text-sm font-semibold hover:bg-gray-700 transition">Save</button>
